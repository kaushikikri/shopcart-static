export const Cartcard = ({ product }) => {
    ...
    return (
        <div className="border rounded shadow-md flex flex-wrap justify-between items-center p-4 mb-8 md:flex-row flex-col">
            ...
            <button type="button" className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm py-2 px-2.5  mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Remove</button>
        </div>
    )
}
